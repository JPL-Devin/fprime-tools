...
from fprime.build.builder import GenerateException, UnableToDetectProjectException
from fprime.cli.fbuild import add_fbuild_parsers
from fprime.build.targets.target import Target
from fprime.cli.fpp import add_fpp_parsers
from fprime.cli.build_helper import load_build
from fprime.cli.commands import (
    run_code_format,
    run_hash_to_file,
    run_info,
    run_new,
...
from fprime.cli.help_text import HelpText
from fprime.tools.fpp.visualize import add_fpp_viz_parsers
from fprime.tools.fpp.impl import add_fpp_impl_parsers
...
def utility_entry(args):
    ...
    try:
        ...
        print(
            f"[ERROR] Could not detect project directory for: {parsed.path}",
            file=sys.stderr,
        )
